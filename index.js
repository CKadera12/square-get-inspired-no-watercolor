...
(lib.getinspiredvideo = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgkAqIAAhTIAcAAQAIgBAIADQAIADAGAEQAHAFAEAIQACAFABAEIABAKIgBAKQgBAFgCAEIgFAHIgGAGQgGAFgIADQgKACgGAAgAgZAgIAPAAQAIAAAFgCQAHgCAFgFQAFgDACgHIACgGIABgHIgBgGIgCgHQgCgGgFgEQgFgEgHgCQgFgCgIAAIgPAAg");
	this.shape.setTransform(35.5,0.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgbAqIAAhTIA1AAIAAAKIgpAAIAAAaIAnAAIAAAIIgnAAIAAAdIArAAIAAAKg");
	this.shape_1.setTransform(27.4,0.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAQAqIgVgmIgNAAIAAAmIgLAAIAAhTIAbAAQAFgBAFACQAGABAEADQAEACADAFQACAFAAAGQAAAJgGAGIgGAEIgJACIAYAngAgSgFIAOAAIAHAAQAEgBACgBIAFgFQABgCAAgEQAAgEgBgCIgFgFIgGgCIgGgBIgPAAg");
	this.shape_2.setTransform(20.2,0.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgFAqIAAhTIALAAIAABTg");
	this.shape_3.setTransform(14.5,0.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgbAqIAAhTIAZAAQAHgBAFACQAGACAEACQAEADACAEQACAFAAAGQAAAGgCAFQgDAFgDACQgFACgFACIgMABIgNAAIAAAlgAgPgEIAMAAIAHgBIAHgCQACgCABgDQACgCAAgEQAAgDgCgDQgBgDgCgCIgHgCIgHgBIgMAAg");
	this.shape_4.setTransform(9.7,0.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(2.3,0.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAVAqIgshEIAAAAIAABEIgMAAIAAhTIAPAAIAsBCIAAAAIAAhCIAMAAIAABTg");
	this.shape_6.setTransform(-5.6,0.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgFAqIAAhTIALAAIAABTg");
	this.shape_7.setTransform(-11.9,0.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgFAqIAAhJIgbAAIAAgKIBBAAIAAAKIgbAAIAABJg");
	this.shape_8.setTransform(-19.9,0.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgbAqIAAhTIA1AAIAAAKIgpAAIAAAaIAnAAIAAAIIgnAAIAAAdIArAAIAAAKg");
	this.shape_9.setTransform(-26.6,0.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgLApQgIgDgGgGQgGgGgDgIQgEgJAAgJQAAgJAEgIQADgJAGgGIAHgFIAHgEQAJgCAIAAIAKAAIAJACQAIAEAFAFIgIAIQgEgEgGgDIgGgBIgHgBQgHAAgGACQgGADgEAFQgEAFgDAGQgCAGAAAGQAAAHACAGQADAGAEAFQAEAEAGADQAGADAHAAIALgBIAJgDIAAgYIgTAAIAAgJIAfAAIAAAoQgHAEgIABIgRADQgJgBgJgDg");
	this.shape_10.setTransform(-35.3,0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.getinspiredvideo, new cjs.Rectangle(-41.9,-9.4,83.8,18.8), null);
...
(lib.FindaStore = function(mode,startPosition,loop) {
	...
	this.shape_2.setTransform(20.2,-27.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#D63900").s().p("AgFAqIAAhTIALAAIAABTg");
	this.shape_3.setTransform(14.5,-27.2);
	...
	this.shape_10.setTransform(-35.3,-27.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.FindaStore, new cjs.Rectangle(-41.8,-36.7,83.8,18.8), null);
...
(lib.ctarectanglehovervideo = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#B63100").s().p("AphCRIAAkhITDAAIAAEhg");
	this.shape.setTransform(0,0,1.018,1.044);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.ctarectanglehovervideo, new cjs.Rectangle(-62.1,-15.1,124.3,30.3), null);
...
(lib.ctarollovervideo = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance_1 = new lib.ctarectanglehovervideo();
...
p.nominalBounds = new cjs.Rectangle(-62.1,-15.1,124.3,30.3);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(125).call(this.frame_125).wait(31).call(this.frame_156).wait(3));
	...
	mask_1._off = true;
	mask_1.graphics.p("ArCOTIAAmkIYAAAIAAGkg");
	mask_1.setTransform(83,91.5);

	// cta-rollover
	this.cta_rollover = new lib.ctarollovervideo();
	this.cta_rollover.parent = this;
	this.cta_rollover.setTransform(77,160.4,1.004,1.012,0,0,0,0.1,0.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.cta_rollover).wait(125).to({x:-47.5},0).to({x:80.8,alpha:1},10,cjs.Ease.get(1)).to({x:77},8,cjs.Ease.get(1)).wait(16));

	// get-inspired-mask (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	mask_2.graphics.p("AnVNhIAAjIIT/AAIAADIg");
	mask_2.setTransform(81,86.5);
	...
	mask_3._off = true;
	mask_3.graphics.p("ArCOTIAAmkIYAAAIAAGkg");
	mask_3.setTransform(83,91.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/squaretable.jpg?1508275694001", id:"squaretable"}
	],
	preloads: []
};
